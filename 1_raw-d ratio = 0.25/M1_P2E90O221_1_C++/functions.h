...
int calc_num_lines_textfile(string);                        // function to determine number of lines in a txt file
//----------------------------------------------------------------------------------------------------------------------------------
//----------------------------------------------------------------------------------------------------------------------------------
...
//----------------------------------------------------------------------------------------------------------------------------------
    ...
    void Shape_func_1(vector<int> ,vector<double> , vector<double>& ,vector<double>& ,
                  vector<double> ,vector<double> ,vector<double> ,vector<double> ,
                  vector<double> ,vector<double> ,int ,int ,int ,int ,int,int,vector<double>&,vector<double>&);

    double Shape_function_2(int ,int ,int ,int ,vector<double> ,vector<double> ,vector<double> ,vector<double>);
...
//----------------------------------------------------------------------------------------------------------------------------------
    ...
    void perform_PCGM(vector<double> , int ,vector<double> ,double ,int ,vector<double>&,vector<double> );

    void perform_gauss_seidel(vector<double>, int,vector<double>,double,int,vector<double>&);

    void perform_gauss_jordan(vector<double>, int,vector<double>,vector<double>&);

//----------------------------------------------------------------------------------------------------------------------------------
//                                                  GLOBAL OPERATORS
//----------------------------------------------------------------------------------------------------------------------------------

    void load_global_param(vector<double>&,vector<double>&,vector<double>&,vector<double>&,vector<double>&,int,int,int,vector<double>&,vector<double>&);
    ...
    void extr_reduced_vector(vector<double>&,vector<double>&,vector<double>,vector<int>,vector<double>,int, int,int);
    ...
    void update_ctrl_pt(vector<double>&,vector<double>,int,vector<int>,double,vector<double>);

    void extr_reduced_vector_Kgg(vector<double>&,vector<int>,vector<double>,int, int);

    //double calc_determ(double*,int);
...
//----------------------------------------------------------------------------------------------------------------------------------
    ...
    void calc_phy_pt(vector<int>,vector<double>,vector<double> ,int ,int ,vector<double>& );
...
//                                                     CREATE REPORT
//----------------------------------------------------------------------------------------------------------------------------------
    void create_report_stress(int ,int ,vector<double> ,vector<int>);

    void create_report_deform(int ,int ,vector<double> );

    double calc_equiv(vector<double>);

    void create_report_stress_strain_pt(int ,int ,double ,double );
